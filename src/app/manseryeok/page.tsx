...
const LIFE_QUOTES = [
  // 운명/사주
  "운명은 정해져 있지 않다. 다만 흐름이 있을 뿐.",
  "사주는 설계도일 뿐, 건물을 짓는 건 당신이다.",
  "당신의 사주에는 당신만의 빛나는 길이 있다.",
  "운명은 바꿀 수 없지만, 대하는 태도는 바꿀 수 있다.",
  "같은 사주라도 사는 방식에 따라 전혀 다른 인생이 된다.",
  "좋은 운은 기다리는 게 아니라 만들어가는 것이다.",
  "대운이 바뀌면 사람도 바뀐다. 지금의 나는 영원하지 않다.",
  // 연애/관계
  ...
  "포기하려는 그 순간이 터닝포인트일 수 있다.",
  "지금 겪는 모든 일은 미래의 당신을 만드는 재료다.",
  "세상에서 가장 정확한 점은 노력이다.",
  // 유머/위트
  "점을 보러 왔는데 점이 나를 보고 있다.",
  "사주가 좋아도 출근은 해야 한다.",
  "오행이 다 있어도 돈이 없으면 의미 없다는 게 함정.",
  "운명의 상대를 찾으려면 일단 밖에 나가야 한다.",
  "별자리가 아무리 좋아도 알람은 울린다.",
  "전생에 나라를 구했으면 이번 생은 좀 편해야 하는데.",
  "내 사주는 대기만성형이래. 근데 대기가 너무 길다.",
  "복채 대신 좋아요 눌러주세요.",
  // 팩트/현실
  "좋은 인연은 준비된 사람에게 온다.",
  "타이밍이 안 맞는 것은 실패가 아니라 준비 기간이다.",
  "연애는 타이밍이다. 아무리 좋은 사람도 시기가 맞지 않으면 독이 된다.",
  "상처받을까 봐 표현 안 하면, 결국 표현 안 해서 상처받게 된다.",
  "좋은 연애는 서로를 변화시키지만, 나쁜 연애는 서로를 소모시킨다.",
  "그 사람이 당신의 전부가 되는 순간, 당신은 그 사람의 옵션이 된다.",
  "헤어지자는 말은 갑자기 나온 게 아니다. 당신만 몰랐을 뿐.",
  "관계에서 가장 중요한 건 존중이다. 사랑은 그 다음이다.",
  "과거를 놓지 못하는 건 미련이 아니라 습관이다.",
  "모든 만남에는 배울 점이 있고, 모든 이별에는 성장이 있다.",
]
