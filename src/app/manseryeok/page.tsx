...
const LIFE_QUOTES = [
  // 출처: 위키인용집, brunch, sciencelove.com
  "사랑은 서로를 바라보는 것이 아니라, 함께 같은 방향을 바라보는 것이다. — 생텍쥐페리",
  "사랑은 눈으로 보지 않고, 마음으로 본다. — 셰익스피어",
  "사랑이 두려운 것은 사랑이 깨지는 것보다 사랑이 변하는 것이다. — 니체",
  "인생은 사랑이며, 그 생명은 정신이다. — 괴테",
  "사랑의 치료법은 더욱 사랑하는 것밖에는 없다. — 소로",
  "사람은 사랑할 때 누구나 시인이 된다. — 플라톤",
  "가장 큰 행복이란, 사랑하고 그 사랑을 고백하는 것이다. — 앙드레 지드",
  "사랑과 기침은 감출 수 없다. — G. 허버트",
  "다른 사람을 사랑하는 것만큼 예술적인 것이 없다. — 빈센트 반 고흐",
  "사랑은 두 개의 육체에 거주하는 하나의 영혼이다. — 아리스토텔레스",
  "사랑이 있는 곳에 생명이 있다. — 마하트마 간디",
  "우리는 위대한 일을 할 수 없습니다. 오로지 작은 일을 위대한 사랑으로 해 나갈 뿐입니다. — 테레사 수녀",
  "항상 웃는 얼굴로 서로를 만납시다. 웃음은 사랑의 시작이기 때문입니다. — 테레사 수녀",
  "사랑은 내가 선택할 수 있는 것이 아닙니다. 그저 내게 다가오는 것입니다. — 캐서린 햅번",
  "진짜 사랑은 언젠가는 상대의 마음에 가서 닿는다. — 왕조현",
  "사랑은 온 우주가 단 한 사람으로 좁혀지는 기적이다. — 줄리아 로버츠",
  "사랑은 그 사람의 백 가지 모습을 모두 아름답게 볼 줄 아는 마음이다. — 데이비드 베컴",
  "아름다운 이별은 없습니다. 다만 아름답게 사랑한 후에는 좋은 추억이 남습니다. — 샤론 스톤",
  "사랑에 대한 유일한 승리는 탈출이다. — 나폴레옹",
  "사랑은 왕궁에서뿐 아니라 오두막집에서도 산다. — J. 레이",
  "어떤 끈이나 밧줄도 사랑으로 꼰 실만큼 강하게 끌어당기지 못한다. — 제임스 호웰",
  "사랑하며 가난한 것이 애정 없는 부유함보다 훨씬 낫다. — L. 모리스",
  "그 사람의 미덕과 인품에 이끌려 가까이 다가갈 때, 비로소 사랑은 시작된다. — 그라시안",
  "인생에서 가장 소중히 간직해야 할 것은 서로입니다. — 오드리 헵번",
]
...
export default function ManseryeokPage() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setQuoteIdx((p) => { let n; do { n = Math.floor(Math.random() * LIFE_QUOTES.length) } while (n === p && LIFE_QUOTES.length > 1); return n })
    }, 3500)
