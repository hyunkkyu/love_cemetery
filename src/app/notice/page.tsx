...
/*
 * [공지사항 업데이트 규칙]
 * 기능 추가/버그 수정/개선 배포 시 NOTICES 배열 맨 앞에 항목 추가:
 * - version: 시맨틱 버전 (major.minor.patch)
 * - date: 배포 날짜 (YYYY-MM-DD)
 * - title: 한 줄 요약
 * - type: "feature" | "fix" | "improve"
 * - items: 변경 항목 배열 (이모지 + 설명)
 */
const NOTICES: Notice[] = [
  {
    ...
    type: "improve",
    items: [
      "🔐 닉네임 유일성 강화: 등록된 닉네임은 비밀번호 불일치 시 로그인 거부 + 비밀번호 찾기 유도",
      "🔒 비로그인 GPT 차단: 만세력/궁합/상담/채팅 등 AI 기능은 로그인 필수",
      "🪔 향피우기: 커뮤니티 공감을 🪔향으로 통일, 동반자 묘비에 4종 향 (위로/응원/기도/사랑) + 연기 애니메이션",
      "👻 픽셀 유령 배경: 떠다니는 픽셀 유령/고양이/요정 파티클",
      "📸 궁합 공유 카드: 이미지 저장 + 링크 복사",
      "🎁 초대 코드: 친구 초대 시 양쪽 +200코인",
      "📊 주간 리포트: 홈에 총 유저/묘비/인기사인 표시",
      "📧 이메일 비밀번호 재설정: Gmail SMTP 발송",
      "💔 썸붕 분석실: 팩폭 레벨 조절 + 편집/재분석",
      "📱 모바일 반응형: 햄버거 메뉴 + 날짜 직접 입력",
      "🕐 시진 시간대 표기: 자시(23:30~01:30) 등 실제 시간 추가",
    ],
  },
  {
    version: "2.1.0",
    date: "2026-05-06",
    title: "종합 운명 분석 6학문 + 썸붕 분석실",
    type: "feature",
    items: [
      "🔮 종합 운명 분석: 사주명리+자미두수+수비학+점성학+구성기학+수리성명학 교차검증",
      "💬 분석 후 채팅: 추가 질문 가능 (50코인/회)",
      "💔 썸붕 분석실: 썸이 깨진 이유 객관적 분석 + 연애고수 현실 조언",
      "💣 팩폭 강도 조절: 🧸순한맛~💀극강 5단계",
      "📖 튜토리얼 강화: 9단계 온보딩 + 상세 설명",
    ],
  },
  {
    version: "2.0.0",
